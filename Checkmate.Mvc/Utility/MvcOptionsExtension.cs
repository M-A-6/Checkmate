...
namespace Checkmate.Mvc.Utility
{
    public static class MvcOptionsExtension
    {
        ...
        public static IMvcBuilder AddModelBindingMessagesLocalizer(this IMvcBuilder mvc, IServiceCollection services)
        {
            return mvc.AddMvcOptions(o =>
            {
                ...
                o.ModelBindingMessageProvider.SetAttemptedValueIsInvalidAccessor((x, y) => localizer["'{0}' is not valid value for '{0}' field", x, y]);

                o.ModelBindingMessageProvider.SetValueMustBeANumberAccessor((x) => localizer["'{0}' must be a number", x]);
            });
        }
    }
}